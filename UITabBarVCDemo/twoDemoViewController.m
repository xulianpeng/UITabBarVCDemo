...
@interface twoDemoViewController ()
{
...
@implementation twoDemoViewController
...
- (void)viewDidLoad {
    ...
    aTextView_33.frame = CGRectMake(10, 300, kSCREEN_WIDTH- 20, 100);
...
//    }];
    ...
    aTextView_33.xlp_placeholder = @"请输入简介";
    aTextView_33.xlp_placeholderColor = [UIColor redColor];
//    aTextView_33.xlp_placeholderFont = [UIFont systemFontOfSize:8];;
    **/
